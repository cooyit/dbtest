...
-- model ulke tablosu icin veri

INSERT INTO model_ulke (ulke_id, model_id, dil_adi, aktif) 
VALUES 
(1,5,'Türkçe',TRUE), 
(1,6,'Türkçe',FALSE),
(1,7,'Türkçe',TRUE),
...
-- model seviye tablosu icin veri
...
(7,1),(7,2),(7,3),(7,4),(7,5),
(20,6),(20,9),(20,12),
(21,7),(21,10),(21,13),(21,16);

-- model kullanici kapsami veri
INSERT INTO model_kullanici_kapsami (kullanici_turu_id, model_id)
VALUES
(4, 5),
(4, 6),
(1, 7), (2, 7), (3, 7),
...
INSERT INTO eslesmeler (model_id, boyut_id, kriter_id, seviye_id, gosterge_id,turu, agirligi,aktif)
VALUES
(5, 1, NULL, NULL, 1, 'boyut',    30, 2),  -- taslak
(5, 1, NULL, NULL, 2, 'boyut',    36, 2),
(5, 3, NULL, NULL, 3, 'boyut',    34, 2),

(5, 1, NULL, NULL, 1, 'gosterge', 30, 1), -- aktif
(5, 1, NULL, NULL, 2, 'gosterge', 50, 1),
(5, 3, NULL, NULL, 3, 'gosterge', 20, 1),

(6, 1, 1, NULL, 6, 'boyut',    30, 2),  -- taslak
(6, 4, 2, NULL, 7, 'boyut',    36, 2),
(6, 5, 3, NULL, 8, 'boyut',    34, 2),
(6, 6, 4, NULL, 9, 'boyut',    34, 2),

(6, 1, 1, NULL, 6, 'kriter', 15, 1), -- aktif
(6, 4, 2, NULL, 7, 'kriter', 25, 1),
(6, 5, 3, NULL, 8, 'kriter', 45, 1),
(6, 6, 4, NULL, 9, 'kriter', 15, 1),

(6, 1, 1, NULL, 6, 'gosterge', 30, 1), -- aktif
(6, 4, 2, NULL, 7, 'gosterge', 30, 1),
(6, 5, 3, NULL, 8, 'gosterge', 20, 1),
(6, 6, 4, NULL, 9, 'gosterge', 20, 1),


(7,1, NULL, NULL, NULL, 'boyut',    10, 2),
(7,2, NULL, NULL, NULL, 'boyut',    20, 2),
(7,3, NULL, NULL, NULL, 'boyut',    15, 2),
(7,4, NULL, NULL, NULL, 'boyut',    15, 2),
(7,5, NULL, NULL, NULL, 'boyut',    5, 2),
(7,6, NULL, NULL, NULL, 'boyut',    15, 2),
(7,7, NULL, NULL, NULL, 'boyut',    20, 2),

(7,1, 4, 7, NULL, 'kriter',    30, 2),
(7,2, 5, 1, NULL, 'kriter',    20, 2),
(7,3, 6, 2, NULL, 'kriter',    45, 2),
(7,4, 7, 3, NULL, 'kriter',    16, 2),
(7,5, 8, 4, NULL, 'kriter',    35, 2),
(7,6, 9, 5, NULL, 'kriter',    27, 2),
(7,7, 10, 6, NULL, 'kriter',   21, 2),

(7,1, 11, 7, NULL, 'kriter',    70, 2),
(7,2, 12, 1, NULL, 'kriter',    80, 2),
(7,3, 13, 2, NULL, 'kriter',    55, 2),
(7,4, 14, 3, NULL, 'kriter',    84, 2),
(7,5, 15, 4, NULL, 'kriter',    65, 2),
(7,6, 16, 5, NULL, 'kriter',    73, 2),
(7,7, 17, 6, NULL, 'kriter',   79, 2),



(7,1, 4, 7, 4, 'gosterge',    30, 2),
(7,2, 5, 1, 5, 'gosterge',    40, 2),
(7,3, 6, 2, 6, 'gosterge',    45, 2),
(7,4, 7, 3, 7, 'gosterge',    40, 2),
(7,5, 8, 4, 8, 'gosterge',    35, 2),
(7,6, 9, 5, 9, 'gosterge',    70, 2),
(7,7, 10, 6, 10, 'gosterge',   25, 2),

(7,1, 11, 7, 14, 'gosterge',    50, 2),
(7,2, 12, 1, 15, 'gosterge',    40, 2),
(7,3, 13, 2, 16, 'gosterge',    15, 2),
(7,4, 14, 3, 17, 'gosterge',    25, 2),
(7,5, 15, 4, 18, 'gosterge',    20, 2),
(7,6, 16, 5, 19, 'gosterge',    20, 2),
(7,7, 17, 6, 20, 'gosterge',   33, 2),

(7,1, 11, 7, 22, 'gosterge',    20, 2),
(7,2, 12, 1, 23, 'gosterge',    20, 2),
(7,3, 13, 2, 24, 'gosterge',    40, 2),
(7,4, 14, 3, 25, 'gosterge',    35, 2),
(7,5, 15, 4, 26, 'gosterge',    45, 2),
(7,6, 16, 5, 27, 'gosterge',    10, 2),
(7,7, 17, 6, 28, 'gosterge',   42, 2),




(20,11, NULL, NULL, NULL, 'boyut',    10, 2),
(20,20, NULL, NULL, NULL, 'boyut',    20, 2),
(20,29, NULL, NULL, NULL, 'boyut',    15, 2),
(20,14, NULL, NULL, NULL, 'boyut',    15, 2),
(20,17, NULL, NULL, NULL, 'boyut',    5, 2),
(20,23, NULL, NULL, NULL, 'boyut',    15, 2),
(20,26, NULL, NULL, NULL, 'boyut',    20, 2),

(20,11, 31, 11, NULL, 'kriter',    30, 2),
(20,20, 34, 14, NULL, 'kriter',    20, 2),
(20,29, 37, 17, NULL, 'kriter',    45, 2),
(20,14, 40, 20, NULL, 'kriter',    16, 2),
(20,17, 43, 23, NULL, 'kriter',    35, 2),
(20,23, 46, 26, NULL, 'kriter',    220, 2),
(20,26, 49, 29, NULL, 'kriter',   21, 2),

(20,1, 52, 11, NULL, 'kriter',    200, 2),
(20,2, 55, 14, NULL, 'kriter',    80, 2),
(20,3, 58, 17, NULL, 'kriter',    55, 2),
(20,4, 61, 20, NULL, 'kriter',    84, 2),
(20,5, 64, 23, NULL, 'kriter',    65, 2),
(20,6, 67, 26, NULL, 'kriter',    203, 2),
(20,20, 70, 29, NULL, 'kriter',   209, 2),



(20,11, 31, 11, 68, 'gosterge',    30, 2),
(20,20, 34, 14,71,'gosterge',    40, 2),
(20,29, 37, 17,74, 'gosterge',    45, 2),
(20,14, 40, 20,77, 'gosterge',    40, 2),
(20,5, 64, 23, 80,'gosterge',    35, 2),
(20,5, 64, 23, 83, 'gosterge',    200, 2),
(20,20, 70, 29, 86, 'gosterge',   25, 2);

/*
(20,1, 11, 20, 14, 'gosterge',    50, 2),
(20,2, 12, 1, 15, 'gosterge',    40, 2),
(20,3, 13, 2, 16, 'gosterge',    15, 2),
(20,4, 14, 3, 120, 'gosterge',    25, 2),
(20,5, 15, 4, 18, 'gosterge',    20, 2),
(20,6, 16, 5, 19, 'gosterge',    20, 2),
(20,20, 120, 6, 20, 'gosterge',   33, 2),

(20,1, 11, 20, 22, 'gosterge',    20, 2),
(20,2, 12, 1, 23, 'gosterge',    20, 2),
(20,3, 13, 2, 24, 'gosterge',    40, 2),
(20,4, 14, 3, 25, 'gosterge',    35, 2),
(20,5, 15, 4, 26, 'gosterge',    45, 2),
(20,6, 16, 5, 220, 'gosterge',    10, 2),
(20,20, 120, 6, 28, 'gosterge',   42, 2);
*/

-- 2. Türkçe ana kayıtlar
INSERT INTO gosterge_cevabina_oneriler 
(gosterge_cevap_id, kullanici_turu_id, gosterge_cevabina_oneri, dil_adi, olusturan_kisi)
VALUES
(NULL, 1, 'Cevap 1 için öneri cümlesi.', 'Türkçe', 'SYSTEM'),
(NULL, 1, 'Cevap 2 için öneri cümlesi.', 'Türkçe', 'SYSTEM'),
(NULL, 1, 'Cevap 3 için öneri cümlesi.', 'Türkçe', 'SYSTEM'),
(NULL, 1, 'Cevap 4 için öneri cümlesi.', 'Türkçe', 'SYSTEM'),
(NULL, 1, 'Cevap 5 için öneri cümlesi.', 'Türkçe', 'SYSTEM'),
(NULL, 1, 'Cevap 6 için öneri cümlesi.', 'Türkçe', 'SYSTEM');


-- İngilizce örnek
INSERT INTO gosterge_cevabina_oneriler 
(ust_gosterge_cevabina_oneriler_id, gosterge_cevap_id, kullanici_turu_id, gosterge_cevabina_oneri, dil_adi, olusturan_kisi)
VALUES 
(7, NULL, 1, 'Suggestion sentence for answer 1.', 'English', 'SYSTEM'),
(8, NULL, 1, 'Suggestion sentence for answer 2.', 'English', 'SYSTEM'),
(9, NULL, 1, 'Suggestion sentence for answer 3.', 'English', 'SYSTEM'),
(10, NULL, 1, 'Suggestion sentence for answer 4.', 'English', 'SYSTEM'),
(11, NULL, 1, 'Suggestion sentence for answer 5.', 'English', 'SYSTEM'),
(12, NULL, 1, 'Suggestion sentence for answer 6.', 'English', 'SYSTEM');


-- İspanyolca
INSERT INTO gosterge_cevabina_oneriler (ust_gosterge_cevabina_oneriler_id, gosterge_cevap_id, kullanici_turu_id, gosterge_cevabina_oneri, dil_adi, olusturan_kisi)
VALUES 
(1, NULL, 1, 'Frase de sugerencia para la respuesta 1.', 'Español', 'SYSTEM'),
(2, NULL, 1, 'Frase de sugerencia para la respuesta 2.', 'Español', 'SYSTEM'),
(3, NULL, 1, 'Frase de sugerencia para la respuesta 3.', 'Español', 'SYSTEM'),
(4, NULL, 1, 'Frase de sugerencia para la respuesta 4.', 'Español', 'SYSTEM'),
(5, NULL, 1, 'Frase de sugerencia para la respuesta 5.', 'Español', 'SYSTEM'),
(6, NULL, 1, 'Frase de sugerencia para la respuesta 6.', 'Español', 'SYSTEM');

-- Arapça
INSERT INTO gosterge_cevabina_oneriler (ust_gosterge_cevabina_oneriler_id, gosterge_cevap_id, kullanici_turu_id, gosterge_cevabina_oneri, dil_adi, olusturan_kisi)
VALUES 
(1, NULL, 1, 'جملة اقتراح للإجابة 1.', 'العربية', 'SYSTEM'),
(2, NULL, 1, 'جملة اقتراح للإجابة 2.', 'العربية', 'SYSTEM'),
(3, NULL, 1, 'جملة اقتراح للإجابة 3.', 'العربية', 'SYSTEM'),
(4, NULL, 1, 'جملة اقتراح للإجابة 4.', 'العربية', 'SYSTEM'),
(5, NULL, 1, 'جملة اقتراح للإجابة 5.', 'العربية', 'SYSTEM'),
(6, NULL, 1, 'جملة اقتراح للإجابة 6.', 'العربية', 'SYSTEM');



INSERT INTO gosterge_cevaplari 
(gosterge_id, gosterge_cevap_turu_id, gosterge_cevap_adi, gosterge_cevap_puani, gosterim_sirasi, dil_adi, aktif, olusturan_kisi)
VALUES 
(4, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(4, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(1, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(1, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(5, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(5, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(5, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(5, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(5, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM'),

(2, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(2, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(3, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(3, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(6, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(6, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(6, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(6, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(6, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM'),

(7, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(7, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(8, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(8, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(10, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(10, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(10, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(10, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(10, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM'),


(9, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(9, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(14, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(14, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),

(15, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(15, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(16, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(16, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),



(17, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(17, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),
(18, 1, 'Evet', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(18, 1, 'Hayır', 0, 2, 'Türkçe', 1, 'SYSTEM'),


(1, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(1, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(1, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(1, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(1, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM'),

(15, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(15, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(15, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(15, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(15, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM'),


(16, 2, 'Kesinlikle Katılıyorum', 100, 1, 'Türkçe', 1, 'SYSTEM'),
(16, 2, 'Katılıyorum', 75, 2, 'Türkçe', 1, 'SYSTEM'),
(16, 2, 'Kararsızım', 50, 3, 'Türkçe', 1, 'SYSTEM'),
(16, 2, 'Katılmıyorum', 25, 4, 'Türkçe', 1, 'SYSTEM'),
(16, 2, 'Kesinlikle Katılmıyorum', 0, 5, 'Türkçe', 1, 'SYSTEM');


ALTER TABLE modeller ADD COLUMN etiketler TEXT;
ALTER TABLE modeller ADD COLUMN hiyerarsi BOOL;


UPDATE eslesmeler
SET turu = 'gösterge'  
WHERE model_id = 7 AND turu = 'gosterge';

UPDATE eslesmeler
SET kullanici_turu_id = 4  
WHERE model_id = 7 AND turu = 'gösterge';


UPDATE eslesmeler
SET kullanici_turu_id = 4  
WHERE model_id = 7 AND turu = 'boyut';


UPDATE eslesmeler
SET kullanici_turu_id = 4  
WHERE model_id = 7 AND turu = 'kriter';

UPDATE modeller
SET hiyerarsi = CASE
    -- Belirli model_id'ler için true yap
    WHEN model_id IN (6, 7, 20) THEN true
    -- Diğer tüm model_id'ler için false yap
    ELSE false
END;
